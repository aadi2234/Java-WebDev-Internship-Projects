 ...
 <!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="viewUserCargo.jsp">
          <i class="bi bi-card-list"></i>
    ...
    <section class="section">
      <div class="row">
        ...
        <!-- Bordered Table -->
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">All Cargo</h5>
              <!-- Bordered Table -->
  	...
  	try
  	{
  		...
  		PreparedStatement ps = con.prepareStatement("Select * from addcargo");
