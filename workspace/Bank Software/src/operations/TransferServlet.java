...
//            response.sendRedirect("viewAccount.jsp");
    ...
    private void updateAccountBalance(Connection con, int accountNumber, double amount) throws Exception {
        String updateQuery = "UPDATE accounts SET bal = bal + ? WHERE accno = ?";
        try {
